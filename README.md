...
For example if you see in your "bus_boarding_api/settings.py" a variable named like
`random_parameter`, you should provide the "BUS_BOARDING_API_RANDOM_PARAMETER"
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `bus_boarding_api.settings.Settings.Config`.
